...
| Client resumable staging state       | Interrupted local sync work                 | `models/.staging/*/.modelshelf/staging.json`            | Reuse only when artifact ID and content digest match; otherwise remove the incompatible staging tree before copying.                                                               |
