...
export function IntegrationPage() {
  ...
  const lockExample = `schemaVersion: 2\nmodels:\n  - alias: qwen-gguf\n    provider: modelscope-cn\n    id: unsloth/Qwen3-8B-GGUF\n    revision: master\n    files:\n      - Qwen3-8B-Q4_K_M.gguf\n    resolvedRevision: 7dbbc90392e2f80f3d3c277d6e90027e55de9125\n    artifactId: modelscope-cn:...:files:...\n    relativePath: modelscope-cn/unsloth/Qwen3-8B-GGUF/7dbbc90392e2f80f3d3c277d6e90027e55de9125~files-...\n    lockedAt: 2026-08-27T14:30:00Z`;
  ...
  return <div className="page integration-page">
    ...
    <section className="integration-section" id="client-cli">
      ...
      <div className="config-notes">
        ...
        <div><strong>files</strong><span>Optional paths for one complete GGUF variant recognized by the server. Split variants must include every shard; the set is part of immutable artifact identity.</span></div>
      ...
      <div className="command-reference panel">
        ...
        <div><code>modelshelf add &lt;provider&gt; &lt;model-id&gt; [-r revision] [--file path] [--alias alias] [--path path]</code><p>Add or update desired state and immediately sync. Repeat <code>--file</code> for every shard in one recognized GGUF variant. If the artifact is missing and <code>writeToken</code> exists, create a server download task.</p></div>
